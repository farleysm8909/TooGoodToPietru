      ...
      <section id="cd-timeline" className="cd-container cssanimations">
        ...
        <div className="cd-timeline-block">
          ...
          <div className="cd-timeline-content">
            ...
            <p>
              After work, Sam met Scott in person for the first time and saw him
              three times that week. They became exclusive not long after.
            </p>
          </div>
        </div>
        <div className="cd-timeline-block">
          ...
          <div className="cd-timeline-content">
            <h3>June 2021</h3>
            <p>
              Sam drives ~24 hours from Tower, MN to Arlington, MA and moves in
              to a long-term Airbnb where she continues to date Scott. Since
              Scott had already lived in Boston for three years and was the only
              person Sam knew there aside from coworkers, he became her
              unofficial tour guide of the city.
            </p>
          </div>
        </div>
        <div className="cd-timeline-block">
        ...
        <div className="cd-timeline-block">
          ...
          <div className="cd-timeline-content">
            ...
            <p>
              Scott proposes to Sam by the lake at her family's cabin in Tower,
              MN, after a 24 mile bike ride. Friends and family showed up for
              the surprise and spent the weekend celebrating together at the
              cabin.
            </p>
            <p>
        ...
        <div className="cd-timeline-block">
          ...
          <div className="cd-timeline-content">
            ...
            <p>
              ...
              relationship and look forward to celebrating it with their friends
              and family.
            </p>
          </div>
        </div>
